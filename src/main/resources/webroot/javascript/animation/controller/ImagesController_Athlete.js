...
export default class ImagesController_Athlete {
    #idx = 0;
    #hash   = null;
    #imgFor;
    #imgFile;
    ...
    constructor() {
        this.questionPrompts = [
            ["Please add 3 photos demonstrating your athletic accomplishments.",
            "These work best if they are all the same size. Each image has" +
            "1/3rd of the total width.","These should be between 400px to 600px wide and no more than 600px tall"],
            ["Please add a second photo"],
            ["Please add a third photo"],
        ...
        this.#idx = 0;
        this.#imgFor = "";
        this.#sizeAry = [100,100,100];
        this.#altDescript = "";
    }

    startAthleteImgTypewriter() {
    ...
    #getImgFor() {
        // Same as the img element the id.
        return "athlete-img-" + this.#idx;
    }
