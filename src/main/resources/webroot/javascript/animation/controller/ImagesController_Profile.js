...
export default class ImagesController_Profile {
    #idx = 0;
    //#isLast = false;
    #hash       = null;
    ...
    constructor() {
        this.questionPrompts = [
            ["Please add your main profile image.", "Images should be between 600px to 800px square."],
            ["Thank you.", "Please add a background photo. It works best if it is 800px by 200px."],
        ...
        //this.buttonOne = document.getElementById("edit_main_imgs");
        this.#idx = 0;

        // Bind event listeners to the buttons
        //this.buttonOne.onclick = () => this.startImgTypewriter();
    }


    startProfImgTypewriter() {
     ...
     * process the users responses and push them
     * into the array.
     * @param file
