<div class="row ">
    <div class="col-md-6 col-sm-12">
        <h2 class="bud-heading-style bud-subheader">Sign up for MyVIDI today</h2>
    </div>
    <div class="col-md-6 col-sm-12">
        <p class="bud-body">
            Limited early access is now open! Be one of the first to raise your MyVIDI and gain a
        ...
        <p class="bud-body">
            <#--                            <b>It's to your advantage.</b>-->
        </p>
        <div class="text-center top-margin-btn">
            <button type="button" class="btn-index" id="button_download" data-bs-toggle="modal"
