...
<head>
    <meta charset="UTF-8">
    <link rel="canonical" href="https://MyVIDI.com/jobs_all">
    <#include "common/icon_block.ftl">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="title" content="Jobs/Internships details">
    <#-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="https://MyVIDI.com/jobs_all">
...
<div class="container" >
                            ...
                            <div class="card-body" style="overflow-y: auto">
                                ...
                                <div class="card-text">
                                    ...
                                    <p><b>To apply:</b> Use your university email and send your resume and required documents to:
                                        <a id="my_email" href="mailto:opportunities@MyVIDI.com"><i class="fas fa-paper-plane"></i> opportunities@MyVIDI.com</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="row">
        <div class="col-md-12 bg-black">
            ...
            <br>
            <p>At MyVIDI, we embrace difference. We don't just accept it - we thrive on it for the benefit of our
                employees, our products and our community. MyVIDI
                Inc. is an equal opportunity employer. Employment at MyVIDI is based solely on a person's
                merit and qualifications directly related to professional competence. MyVIDI does not discriminate
                ...
                It is MyVIDI's policy to comply with all applicable national, state and local laws pertaining
