...
<html lang="en-us">
<head>
    <title>Our Backers: VertxExample</title>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <link rel="canonical" href="https://VertxExample.com/our-backers">
    ...
    <meta property="og:url" content="https://VertxExample.com/our-backers">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 top-margin-top mb-4">
                    ...
                    <p class="act-like-h1">Our VertxExample Superheroes</p>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12">
